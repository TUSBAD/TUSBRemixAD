...
#effect一覧
    ...
    # 詳しくはwiki見てね！
# data modify storage asset: mob.active_effects append value {Id:minecraft:aqua_affinity,Amplifier:1,Duration:600,ShowParticles:0b}
# data modify storage asset: mob.active_effects append value {Id:5,Amplifier:4,Duration:600,ShowParticles:0b}
# 或いは...
# data modify storage asset: mob.active_effects set value [{Id:minecraft:aqua_affinity,Amplifier:1,Duration:600,ShowParticles:0b},{Id:5,Amplifier:4,Duration:600,ShowParticles:0b}]
