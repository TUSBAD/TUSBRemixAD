...
# 或いは...
# data modify storage asset: mob.active_effects set value [{Id:minecraft:aqua_affinity,amplifier:1,duration:600,show_particles:0b},{Id:5,amplifier:4,duration:600,show_particles:0b}]
