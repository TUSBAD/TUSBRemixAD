...
#effect一覧
    ...
    # 詳しくはwiki見てね！
# data modify storage asset: mob.active_effects append value {Id:minecraft:aqua_affinity,amplifier:1,duration:600,show_particles:0b}
...
# 或いは...
# data modify storage asset: mob.active_effects set value [{Id:minecraft:aqua_affinity,amplifier:1,duration:600,show_particles:0b},{id:"minecraft:strength",amplifier:4,duration:600,show_particles:0b}]
