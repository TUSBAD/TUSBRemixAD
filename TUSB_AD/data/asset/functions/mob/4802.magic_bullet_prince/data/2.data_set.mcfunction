...
# 23:saturation(27)(6t)
    ...
    # Passengers
    data modify storage asset: mob.Passengers append value {id:"minecraft:potion",Item:{id:"minecraft:splash_potion",Count:1b,tag:{custom_potion_effects:[{id:"minecraft:invisibility",amplifier:-1b,duration:60},{id:"minecraft:levitation",amplifier:-120b,duration:1200}]}}}
