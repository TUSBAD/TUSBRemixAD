...
# 演出用AEC、
    data modify storage asset: mob.Passengers set value [{id:"area_effect_cloud",duration:100,Particle:"end_rod",Radius:0.1},{id:"potion",Item:{id:"minecraft:splash_potion",Count:1b,tag:{Custom_Potion_Effects:[{id:"minecraft:instant_damage",amplifier:1b,duration:1},{Id:17,amplifier:0b,duration:100}]}}}]
