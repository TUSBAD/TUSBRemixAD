...
# 表示
    $tellraw @a ["",{"translate":"難易度を%1$sへ変更する。","with":[$(text)]}," ",{"translate":"→拒否する","bold":true,"underlined":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ChangeDifficulty set 1"}}]
