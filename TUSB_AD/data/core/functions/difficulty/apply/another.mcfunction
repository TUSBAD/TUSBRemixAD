...
#> チーム色変更
execute unless data storage tusb_remake: difficult{world:"another"} run function core:difficulty/color/another

data modify storage tusb_remake: difficult.before set from storage tusb_remake: difficult.world
data modify storage tusb_remake: difficult.world set value "another"
...
#> チャット表示
tellraw @a [{"storage":"tusb_remake:","nbt":"Prefix.SUCCESS"},{"translate":"難易度を%1$sに変更しました。","with":[{"translate":"アナザー","color":"#FF00FF"}]}]
