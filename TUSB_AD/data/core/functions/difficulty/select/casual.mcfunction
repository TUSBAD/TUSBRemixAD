#> core:difficulty/select/casual
#
#
#
# @within function core:difficulty/change/adopt
#declare storage core: difficult

# 難易度適用
execute if data storage core: difficult{world:"casual"} run tellraw @a {"translate":"この難易度を選択中です。"}

execute unless data storage core: difficult{world:"casual"} run function core:difficulty/apply/casual
