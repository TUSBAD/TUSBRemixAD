...
data modify storage skill: _.2 set value {name:["ヘイカモンα","ヘイカモンβ"],level:[13,33],cost:10,description:[["周囲のペットを５体まで引き寄せる。"],["周囲のペットを10体まで引き寄せる。"]],range:[15],sneak:{description:[["周囲のプレイヤーも１人まで引き寄せる。"],["周囲のプレイヤーも２人まで引き寄せる。"]],range:[15]}}
data modify storage skill: _.3 set value {name:["サモンE:スーパードラゴン"],level:[17],cost:35,description:[["スーパードラゴンを召喚する。"]]}
data modify storage skill: _.4 set value {name:["サモンP：ウルフ"],level:[25],cost:40,description:[["オオカミ(ペット)を召喚する。","HP：✮✮✮✩✩","攻：✮✮✮✮✮","防：✮✮✮✩✩","特性：火炎耐性","支援：攻撃力上昇"]]}
data modify storage skill: _.5 set value {name:["サモンE:ヒーリングキャット"],level:[30],cost:45,description:[["ぬこかわいいよぬこ。"]],duration:[10]}
data modify storage skill: _.6 set value {name:["サモンP：ゴーレム"],level:[45],cost:50,description:[["アイアンゴーレム(ペット)を召喚する。","HP：✮✮✮✮✮","攻：✮✮✮✮✩","防：✮✮✮✮✩","特性：射撃耐性","支援：防御力上昇"]]}
data modify storage skill: _.7 set value {name:["サモンE:バルーン"],level:[46],cost:55,description:[["熱気球を召喚する。"]]}
...
data modify storage skill: _.23 set value {name:["ぽんぽんα","ぽんぽんβ"],level:[15,35],cost:10,description:[["周囲のペットを回復する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[15]}
data modify storage skill: _.24 set value {name:["つんつんα","つんつんβ"],level:[18,38],cost:10,description:[["ペットに命令する。","ニンジン付き：支援しろ！","歪んだキノコ付き：技を使え！"]],condition:"〇〇付きの棒を持って右クリック",range:[15]}
data modify storage skill: _.25 set value {name:["あつあつタライ"],level:[23],cost:10,description:[["周囲の敵の頭上にあつあつタライを召喚する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[15]}
data modify storage skill: _.26 set value {COMMENT:"/* 効果時間が文字列なので正常に反映できない可能性あり */",name:["サモンB:オブシディアン"],level:[26],cost:20,description:[["黒曜石を召喚する。","上空では長く保たない。"]],condition:"ニンジン付きの棒を持って右クリック",duration:"1～25"}
data modify storage skill: _.27 set value {name:["ぽむぽむハナビ"],level:[37],cost:10,description:[["ぽむぽむハナビを召喚する。"]],condition:"ニンジン付きの棒を持って右クリック"}
data modify storage skill: _.28 set value {COMMENT:"/* 26@6mと同様 */",name:["サモンB:エンダーチェスト"],level:[39],cost:40,description:[["エンダーチェストを召喚する。","上空では長く保たない。"]],condition:"ニンジン付きの棒を持って右クリック",duration:"1～25"}
data modify storage skill: _.29 set value {name:["きらきらタライ"],level:[43],cost:15,description:[["周囲の敵の頭上にきらきらタライを召喚する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[15]}
data modify storage skill: _.30 set value {name:["サモン:ぷちブラック"],level:[50],cost:100,description:[["ぷちブラックホールを召喚する。"]],condition:"ニンジン付きの棒を持って右クリック",duration:[15]}
data modify storage skill: _.31 set value {name:["§bテスラフレア"],level:[51],cost:70,description:[["自身の位置に敵を引き寄せ硬直させたのちで電子爆発を起こす。ただし小ダメージを受ける。"]],condition:"ニンジン付きの棒を持って右クリック",range:[20]}
data modify storage skill: _.32 set value {name:["§dインバイトアビス"],level:[100],cost:60,description:[["もっとも近い敵を中心に深淵の遺物を召喚する。召喚された遺物は最も近い敵に特大ダメージ、周囲の敵に大ダメージを与えヒットした敵のバフを解除する。攻撃成功時、攻撃された敵周囲の味方のデバフを解除しバフと体力回復を付与する"]],condition:"ニンジン付きの棒を持って右クリック",range:[20]}
execute if data storage skill: {skill_liberation:1b} run data modify storage skill: _.33 set value {name:["§6ファイナルカタストロフィ"],level:[100],cost:500,description:[["もっとも近い敵を中心に深淵の魔物を召喚する。召喚された魔物は周囲を一掃する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[30]}

data modify storage skill: skill_table.summoner set from storage skill: _
