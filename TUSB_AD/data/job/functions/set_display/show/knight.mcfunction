...
execute if score @s ShowSkill matches 1260 run data modify storage tusb_remake: skill_name set value "§b§lウォープレリュード"
execute if score @s ShowSkill matches 1270 run data modify storage tusb_remake: skill_name set value "§d§l夢想真説"
execute if score @s ShowSkill matches 1280 run data modify storage tusb_remake: skill_name set value "§6§lブレードワルツ"
