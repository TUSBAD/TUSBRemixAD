...
execute if score @s ShowSkill matches 6310 run data modify storage tusb_remake: skill_name set value "§b§lテスラフレア"
execute if score @s ShowSkill matches 6320 run data modify storage tusb_remake: skill_name set value "§d§lインバイトアビス"
execute if score @s ShowSkill matches 6330 run data modify storage tusb_remake: skill_name set value "§6§lファイナルカタストロフィ"
