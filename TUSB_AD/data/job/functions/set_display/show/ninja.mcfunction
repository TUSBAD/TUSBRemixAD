...
execute if score @s ShowSkill matches 2250 run data modify storage tusb_remake: skill_name set value "§d§l太素診要"
execute if score @s ShowSkill matches 2260 run data modify storage tusb_remake: skill_name set value "§d§l靖妖儺舞"
execute if score @s ShowSkill matches 2270 run data modify storage tusb_remake: skill_name set value "§6§l奥義・瞬獄殺"
