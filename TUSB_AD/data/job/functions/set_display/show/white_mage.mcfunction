...
execute if score @s ShowSkill matches 4240 run data modify storage tusb_remake: skill_name set value "§b§l天気雨"
execute if score @s ShowSkill matches 4250 run data modify storage tusb_remake: skill_name set value "§d§lホーリーシャワー"
execute if score @s ShowSkill matches 4260 run data modify storage tusb_remake: skill_name set value "§d§lセイクリッドオーラ"
execute if score @s ShowSkill matches 4270 run data modify storage tusb_remake: skill_name set value "§6§l聖・ソウルイグニッション"
