#> job:skill/white_mage/flower_gift/schedule/fly
### フラワーギフトが飛んでいる演出
### Copyright © 2022 赤石愛
...
execute if entity @s[tag=FlowerGift1] as @e[distance=..5,type=#lib:mob,tag=Enemy] at @s run function job:skill/white_mage/flower_gift/schedule/hit/1
