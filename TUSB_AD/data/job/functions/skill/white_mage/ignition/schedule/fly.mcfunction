...
execute as @e[distance=..10,type=#lib:mob,tag=Enemy,nbt=!{active_effects:[{id:"minecraft:saturation"}]}] at @s run function job:skill/white_mage/ignition/schedule/hit
