...
### 手裏剣カウントの有効化
execute in minecraft:overworld run schedule function job:skill/ninja/suriken/count/ 1t

### 手裏剣の演出有効化
function job:skill/ninja/suriken/schedule/
