#> job:skill/archer/chain_arrow/hit/
# チェインアローが直接当たった時
...
execute if score Level TUSB matches 2..9 as @e[distance=..25,type=#lib:mob,tag=Enemy,sort=random] at @s run function job:skill/archer/chain_arrow/hit/damage
