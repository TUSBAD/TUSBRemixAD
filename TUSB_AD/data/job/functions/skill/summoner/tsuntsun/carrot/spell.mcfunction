#> job:skill/summoner/tsuntsun/carrot/spell
# つんつん(ニンジン棒)を詠唱(624X)
### Copyright © 2022 赤石愛
...
execute if score _ ActivatedSkill matches 6240..6249 run function job:skill/summoner/tsuntsun/carrot/cast
