#> job:skill/summoner/tsuntsun/fungus/cast
# つんつんを詠唱(624X)
### Copyright © 2022 赤石愛
...
execute as @e[distance=..15,type=wolf,team=FriendlyTeam,nbt=!{Sitting:true}] at @s run function job:skill/summoner/tsuntsun/fungus/attack/wolf
