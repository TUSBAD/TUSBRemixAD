...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#lib:mob,tag=Enemy,nbt=!{active_effects:[{Id:23}]},limit=1] at @s run function job:skill/summoner/blast_basin/schedule
