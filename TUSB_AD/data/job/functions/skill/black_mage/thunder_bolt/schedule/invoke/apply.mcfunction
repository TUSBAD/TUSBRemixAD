#> job:skill/black_mage/thunder_bolt/schedule/invoke/apply
# サンダーボルトの範囲をテスト
### Copyright © 2022 赤石愛
...
### ダメージを与える
execute unless entity @s[nbt={active_effects:[{id:"minecraft:saturation"}]}] run function score_damage:api/attack
