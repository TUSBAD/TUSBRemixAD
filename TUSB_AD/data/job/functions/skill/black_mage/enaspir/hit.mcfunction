#> job:skill/black_mage/enaspir/hit
# エンアスピルの効果を発動させる
### Copyright © 2022 赤石愛
...
execute store result storage skill: _ int 0.005 run scoreboard players operation _ TUSB *= @s EnAspir
execute store result score _ TUSB run data get storage skill: _
