#> job:skill/black_mage/ice_storm/schedule/fly
### アイスストームが飛んでいる演出
### Copyright © 2022 赤石愛
...
execute as @e[distance=..8,type=#lib:mob,type=!#lib:resist_ice,tag=Enemy,nbt=!{active_effects:[{id:"minecraft:saturation"}]}] at @s run function job:skill/black_mage/ice_storm/schedule/hit
