#> job:skill/black_mage/cross_fire/schedule/hit
# クロスファイアーが当たった時
### Copyright © 2022 赤石愛
...
execute if entity @s[type=#lib:burnable,nbt=!{active_effects:[{id:"minecraft:fire_resistance"}]}] store result storage score_damage: Argument.Damage double 0.03 run data get storage score_damage: Argument.Damage 100
### ダメージを与える
