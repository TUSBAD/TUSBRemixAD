...
data modify storage skill: cross_fire_damage set from storage score_damage: Argument.Damage
...
data modify storage score_damage: Argument.Damage set from storage skill: cross_fire_damage
