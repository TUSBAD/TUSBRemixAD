#> job:skill/black_mage/syawa_/cast
...
execute if data storage tusb_remake: {_:true} in minecraft:overworld run schedule function job:skill/black_mage/syawa_/apply 1s
