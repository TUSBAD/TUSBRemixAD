...
### 障害物があったら
execute unless data storage skill: {return_obstacle:0} run tellraw @a {"text":"* 頭上が遮られていたため、発動できなかった！"}
### 障害物がなかったら
execute if data storage skill: {return_obstacle:0} run function job:skill/black_mage/return/apply