#> job:skill/common/dig_tomb/act0
#
...
# スケジュール起動する
    ...
    execute if score _ _ matches 1 run function job:skill/common/dig_tomb/fail
    execute if score _ _ matches 0 run function job:skill/common/dig_tomb/success