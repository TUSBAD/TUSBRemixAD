...
execute store result storage mob: _ int -0.2 run scoreboard players operation @s AgentWarpCost *= @s AgentWarpCost
execute store result score @s AgentWarpCost run data get storage mob: _ -1
