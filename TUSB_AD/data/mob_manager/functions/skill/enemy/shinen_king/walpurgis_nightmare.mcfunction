...
summon AreaEffectCloud ~ ~1.0 ~ {ReapplicantDelay:100,Radius:5.5f,RadiusOnUse:-0.05f,DurationOnUse:0f,Duration:800,WaitTime:0,Age:0,CustomNameVisible:true,ParticleParam1:0152,Particle:fallingdust,Tags:["TypeChacked"],Effects:[{Id:7b,Duration:1,Amplifier:7b,ShowParticles:true}],CustomName:" §4§l終焉の門"}
