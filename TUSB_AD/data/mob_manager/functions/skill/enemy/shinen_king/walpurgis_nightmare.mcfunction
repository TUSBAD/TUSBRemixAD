...
summon AreaEffectCloud ~ ~1.0 ~ {ReapplicantDelay:100,Radius:5.5f,RadiusOnUse:-0.05f,DurationOnUse:0f,duration:800,WaitTime:0,Age:0,CustomNameVisible:true,ParticleParam1:0152,Particle:fallingdust,Tags:["TypeChacked"],effects:[{id:"minecraft:instant_damage",duration:1,amplifier:7b,show_particles:true}],CustomName:" §4§l終焉の門"}
