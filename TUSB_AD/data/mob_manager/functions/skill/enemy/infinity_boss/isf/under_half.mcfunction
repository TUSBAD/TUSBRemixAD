#> mob_manager:skill/enemy/infinity_boss/isf/under_half/
#
# 体力半分以下のISFスキル
#
# @within function mob_manager:skill/enemy/infinity_boss/isf/
