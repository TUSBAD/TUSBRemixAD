...
# damage
    ...
    # attack
        execute at @e[limit=1,tag=GameMaster] as @a[distance=..60,tag=GameMasterBattle] if predicate player_manager:effects/is_poison run function score_damage:api/attack