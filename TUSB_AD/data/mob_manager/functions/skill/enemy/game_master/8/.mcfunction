...
# 武器変更
    data merge entity @e[limit=1,tag=GameMaster] {HandItems:[{id:"minecraft:bow",Count:1b,tag:{display:{Name:'{"text":"Cue","color":"black","bold":true}'},Enchantments:[{id:"minecraft:punch",lvl:20s}]}},{id:"minecraft:tipped_arrow",Count:64b,tag:{custom_potion_effects:[{id:"minecraft:instant_damage",amplifier:3b,duration:60},{id:"minecraft:slowness",amplifier:4b,duration:80},{id:"minecraft:hunger",amplifier:3b,duration:80},{id:"minecraft:levitation",amplifier:4b,duration:20}],Potion:"minecraft:empty",CustomPotionColor:0}}]}
# ノクバ耐性削除
