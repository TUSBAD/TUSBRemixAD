...
summon Villager ~ ~1 ~ {Motion:[0:0.0d,1:-3.0d,2:0.0d],Passengers:[0:{Particle:"witchMagic",Radius:64.0f,ReapplicationDelay:10,CustomName:"§4§lHEALTH §5§lDOWNER§r",RadiusOnUse:0.0f,duration:20,effects:[0:{duration:20,id:"minecraft:instant_damage",amplifier:5b},1:{duration:100,Id:21b,amplifier:0b}],id:"AreaEffectCloud",WaitTime:10},1:{Particle:"dragonbreath",Radius:0.3f,ReapplicationDelay:0,CustomName:"HEALTH_DOWNER",RadiusOnUse:0.0f,duration:50,effects:[],id:"AreaEffectCloud"}],DeathTime:19s,Health:0.0f,Silent:1b,active_effects:[{id:"minecraft:invisibility",amplifier:127b,duration:2147483648}]}
