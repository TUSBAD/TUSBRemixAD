#> mob_manager:skill/enemy/shinsei_king/acceralation/schedule_result
...
# 演出
execute at @e[type=marker,tag=acceralation] run function mob_manager:skill/magic/acceralation/particle


# 上のやつちょっとの猶予時間の後にどーんってやってもいいよなぁ
# 起点マーカーだしてschedule,その後範囲指定してkillかねー

schedule function mob_manager:skill/magic/acceralation/detect 10t
