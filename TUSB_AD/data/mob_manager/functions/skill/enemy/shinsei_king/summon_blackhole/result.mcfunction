#> mob_manager:skill/enemy/shinsei_king/summon_blackhole/result
...
execute at @e[type=marker,tag=Blackhole] run function mob_manager:skill/enemy/shinsei_king/summon_blackhole/particle/