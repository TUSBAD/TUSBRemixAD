...
# 設置位置用AEC
    summon minecraft:armor_stand ~ ~ ~ {Marker:1b,Small:1b,Silent:1b,Invisible:1b,Tags:["LogStand", "HealLog", "ShortShow","TypeChecked","SystemEntity"],CustomName:'""',CustomNameVisible:1b}
...
# 表示
    execute positioned ~ ~ ~ as @e[distance=..0.01,type=minecraft:armor_stand,tag=HealLog,limit=1] run function mob_manager:custom_health/log/show
