#> world_manager:area/entered/cloudia
#
#> クラウディア演出
#
...
title @s subtitle [{"text":"= ","color":"white"},{"text":"蒼天","color":"#23DDFA","bold":true},{"text":"を跨ぐ","color":"#686868","bold":true},{"text":"虹","color":"#ff24a4","bold":true},{"text":"の世界","color":"#686868","bold":true},{"text":" =","color":"white"}]
