...
execute if data storage world: settings{force_night:false} if score _ TUSB matches 11..40 unless data storage world: {clock_stage:1} run function world_manager:dimension/skylands/clock/1
execute if data storage world: settings{force_night:false} if score _ TUSB matches 41..70 unless data storage world: {clock_stage:2} run function world_manager:dimension/skylands/clock/2
execute if data storage world: settings{force_night:false} if score _ TUSB matches 71.. unless data storage world: {clock_stage:3} run function world_manager:dimension/skylands/clock/3
...
# execute if data storage world: {_:false} in minecraft:overworld as @e[x=-1902,y=4,z=-81,dx=24,type=villager,tag=!ShopStaff,sort=random,limit=1] at @s run function world_manager:area/conquer/new_shop
