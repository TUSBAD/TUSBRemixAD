...
### まだ残り回数があったら繰り返し
execute store result storage world: lightning_bolt_count int 0.9999999999 run data get storage world: lightning_bolt_count
execute unless data storage world: {lightning_bolt_count:0} in minecraft:overworld run schedule function world_manager:dimension/purgatory/boss/lightning_bolt/schedule 1t
