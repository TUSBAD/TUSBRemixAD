...
data modify storage world: pattern6.time set value 2

execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/pattern6/count_up/3 1s
