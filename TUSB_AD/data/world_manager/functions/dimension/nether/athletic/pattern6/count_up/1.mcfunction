...
data modify storage world: pattern6.time set value 1

execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/pattern6/count_up/2 1s
