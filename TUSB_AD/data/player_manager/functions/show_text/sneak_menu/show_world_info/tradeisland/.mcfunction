...
tellraw @s [{"translate":"エリア攻略数"}," : ",{"nbt":"conquer.count.tradeisland","storage":"world:"},"/",{"nbt":"conquer.max.tradeisland","storage":"world:"}]
tellraw @s ""
tellraw @s [{"translate":"教会","color":"#ffffff"}," : ",{"storage":"world:","nbt":"capture.tradeisland{001:0}.001","font":"ender_eye","color":"gray"},{"storage":"world:","nbt":"capture.tradeisland{001:1}.001","font":"ender_eye"}]
