...
# 軽減不可ダメージ
  # 引数を設定
    ...
    execute as @s[scores={DoomEx=..0}] run data modify storage score_damage: Argument set value {Damage:1024,EPF:0,BypassAbsorption:true,BypassArmor:true,BypassResistance:true}
