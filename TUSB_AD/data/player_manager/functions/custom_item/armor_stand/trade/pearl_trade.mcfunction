...
# アイテムを渡しましょう
execute if score @s TUSB matches 8.. if score @s TUSB_sub matches 8.. at @s run summon minecraft:bat ~ ~0.1 ~ {Health:0.001f,active_effects:[{Id:14,Amplifier:0b,Duration:100,ShowParticles:false},{Id:7,Amplifier:0b,Duration:100,ShowParticles:false}],Passengers:[{id:"minecraft:item",Item:{id:"minecraft:ender_pearl",Count:16b}}]}