...
# アイテムを渡しましょう
execute if score @s TUSB matches 64.. if score @s TUSB_sub matches 64.. at @s run summon minecraft:bat ~ ~0.1 ~ {Health:0.001f,active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:100,show_particles:false},{id:"minecraft:instant_damage",amplifier:0b,duration:100,show_particles:false}],Passengers:[{id:"minecraft:item",Item:{id:"minecraft:trapped_chest",Count:64b}}]}