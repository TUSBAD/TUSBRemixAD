...
data modify entity @e[tag=SetSpawner,limit=1,sort=nearest] SpawnData set from storage debug: spawn_data

data modify entity @e[tag=SetSpawner,limit=1,sort=nearest] SpawnPotentials set from storage debug: spawn_potentials
