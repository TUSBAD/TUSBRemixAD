...
# 演出
    execute if score $SubtractedHealth ScoreDamageCore matches 1.. if entity @s[type=#score_damage:undead] run summon area_effect_cloud ~ ~ ~ {duration:14,Age:4,effects:[{Id:11,Amplifier:127b,duration:1,ShowParticles:0b},{id:"minecraft:instant_health",Amplifier:0b,duration:1,ShowParticles:0b}]}
